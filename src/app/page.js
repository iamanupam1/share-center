...
async function Home() {
  ...
  return (
    <div id="view" className="h-full w-screen flex flex-row">
      <div
        id="sidebar"
        className="bg-white h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out border-r-2 border-teal-500"
      >
      ...
      <div className="p-5 bg-white h-screen md:block shadow-xl w-full overflow-x-hidden transition-transform duration-300 ease-in-out">
        <h2>
