    ...
    <Layout>
      <div
        className={`grid gap-4 xl:grid-cols-${
          userStocks.length ? "2" : "1"
        } 2xl:grid-cols-${userStocks.length ? "3" : "1"} mb-5`}
      >
        {/* Main widget */}
        {userStocks.length ? (
          <div className="p-4 bg-white border border-gray-200 md:p-6 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
