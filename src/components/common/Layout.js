...
const Layout = ({ children }) => {
  ...
  return (
    <div id="view" className="h-full w-screen flex flex-row">
      <div
        id="sidebar"
        className="bg-gray-900 h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out border-r-4 border-teal-500 text-white"
      >
