      ...
      >
        <div className="space-y-6 md:space-y-10 mt-10">
          ...
          <div id="menu" className="flex flex-col space-y-2">
            <a
              href=""
              className="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:text-base rounded-md transition text-white"
            >
              <svg
                className="w-5 h-5 mr-2 fill-current inline-block"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <a
              href=""
              className="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white rounded-md transition text-white"
            >
              <svg
                className="w-5 h-5 mr-2 fill-current inline-block"
                fill="currentColor"
            ...
            <a
              ...
              href=""
              onClick={() => signOut()}
              className="text-sm font-medium text-gray-700 py-2 px-2 rounded-md transition bg-red-500 text-white"
            >
              <svg
                className="w-5 h-5 mr-2 fill-current inline-block"
                fill="currentColor"
